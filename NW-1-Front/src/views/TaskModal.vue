...
<template>
    <!-- Task Modal -->
    <div class="fixed inset-0 bg-gray-900 bg-opacity-70 flex justify-center items-center text-white z-50 animate__backInUp transition ease-in-out duration-200">
